This is the graph that shows the scatterplot graph of harness size by boot size. GitHub does not allow plotly mages to be included within the Jupyter files so I posted the image here.
